<template>
    <div>
        <div  v-if="ws_data != ''">
            <div v-for="(person, index) in ws_data" class="row" style="background:white;margin-bottom:10px;height:90px;border: 1px solid hsla(0,0%,80%,.5);" :key="person._id">
                <div class="col-6">
                    <img 
                        :src="medals[index]"
